...
void core0_main(void)
{
    ...
    while (1)
    {
        { volatile uint32 r = inl_small_mix(0xDEADBEEFu, 0xCAFEBABEu); (void)r; } turnLEDon(); /* If the global variable g_turnLEDon is TRUE, turn on the LED */
    }
}
